...
import CircleIcon from "@mui/icons-material/Circle"; // Circle icon (default selected)
import DesktopWindowsIcon from "@mui/icons-material/DesktopWindows"; // Computer/Desktop
import MonitorIcon from "@mui/icons-material/Monitor"; // Desktop monitor (Grid-like icon)
import MicIcon from "@mui/icons-material/Mic"; // Microphone
import FormatAlignLeftIcon from "@mui/icons-material/FormatAlignLeft";
import FormatAlignCenterIcon from "@mui/icons-material/FormatAlignCenter";
import FormatAlignRightIcon from "@mui/icons-material/FormatAlignRight";
import TvIcon from "@mui/icons-material/Tv"; // TV/Monitor icon
import LaptopIcon from "@mui/icons-material/Laptop"; // Laptop icon
...
const JoinOurWebinarModal = ({ open, onClose }) => {
  ...
  const [linkText, setLinkText] = useState("How to make an awesome website");
  ...
  // --- Handlers ---
  const handleSave = () => {
    console.log("Saving webinar link settings:", {
      title,
      linkText,
      linkUrl,
      icon,
